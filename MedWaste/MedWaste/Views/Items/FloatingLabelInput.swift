...
//  MedWaste
//
//  Created by Jasmine Aufiero on 01/06/22.
//

/**
 float the label above the input field when the field is selected and remove the placeholder
 */
...
class FloatingLabelInput :UITextField {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        // attach a listener to the text field to fire when the user focuses on a text field and when the cursor is removed
